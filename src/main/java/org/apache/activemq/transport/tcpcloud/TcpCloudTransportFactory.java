 ...
 */
package org.apache.activemq.transport.tcpcloud;
 ...
 *
 */
public class TcpCloudTransportFactory extends TransportFactory {
    private static final Logger LOG = LoggerFactory.getLogger(TcpCloudTransportFactory.class);
    ...
    public TransportServer doBind(final URI location) throws IOException {
        try {
            ...
            TcpCloudTransportServer server = createTcpTransportServer(location, serverSocketFactory);
     ...
     */
    protected TcpCloudTransportServer createTcpTransportServer(final URI location, ServerSocketFactory serverSocketFactory) throws IOException, URISyntaxException {
        return new TcpCloudTransportServer(this, location, serverSocketFactory);
    }
