...
public class TcpCloudTransportServer extends TransportServerThreadSupport implements ServiceListener{

    private static final Logger LOG = LoggerFactory.getLogger(TcpCloudTransportServer.class);
    protected ServerSocket serverSocket;
    protected int backlog = 5000;
    protected WireFormatFactory wireFormatFactory = new OpenWireFormatFactory();
    protected final TcpCloudTransportFactory transportFactory;
    ...
    public TcpCloudTransportServer(TcpCloudTransportFactory transportFactory, URI location, ServerSocketFactory serverSocketFactory) throws IOException, URISyntaxException {
        super(location);
